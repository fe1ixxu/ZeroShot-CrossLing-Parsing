...
from allennlp.training.trainer import Trainer, BatchCallback, TensoboardBatchMemoryUsage, EpochCallback
...
@Trainer.register("iter_norm", constructor="from_partial_objects")
class Iter_Norm_Trainer(Trainer):
    """
    ...
    def _get_iter_norm_mean_train(self, mean) -> torch.Tensor:
        """
    ...
    def _get_iter_norm_mean_eval(self, mean) -> torch.Tensor:
        """
        Traverse training data to get mean embeddings.
        """
