...
local max_length = 1024;
{
    ...
    "validation_data_path": "/export/b15/haoranxu/clce/data/ud-treebanks-v2.6/UD_English-EWT/en_ewt-ud-test.conllu",
    "trainer": {
        "type": "iter_norm",
        "cuda_device": 0,
        "grad_norm": 5,
...
//"/export/c12/haoranxu/clce/uni-dep-tb/universal_treebanks_v2.0/std/de/de-universal-train.conll",