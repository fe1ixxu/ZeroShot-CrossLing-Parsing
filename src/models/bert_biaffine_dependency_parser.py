...
from src.training import AttachmentScoresCuda
...
PREFIX_MODULE_NAME = "text_field_embedder.token_embedder_tokens._matched_embedder.transformer_model."
CLS_ID = 101
SEP_ID = 102
PAD_ID = 0
MASK_ID = 103
...
@Model.register("bert_biaffine_parser")
class BertBiaffineDependencyParser(Model):
    """
